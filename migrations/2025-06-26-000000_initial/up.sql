...
-- Terminal sessions (tabs). Each belongs to a repository and is pinned to
-- one of its worktrees. `id` doubles as the zmx session name (`piyo-<id>`),
-- so it must be stable across launches.
